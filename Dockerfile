...
ENV VITE_ATTENDANCE_CAMERA_MAX_FPS=5
ENV VITE_ATTENDANCE_CAMERA_JPEG_QUALITY=0.65
ENV VITE_ATTENDANCE_CAMERA_MAX_WIDTH=960
ENV VITE_ATTENDANCE_CAMERA_MAX_HEIGHT=540
